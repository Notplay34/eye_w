...
Система управления двумя павильонами автоуслуг: оформление документов, изготовление номеров, учёт платежей, аналитика.
...
**Готово к запуску:** форма документов, изготовление номеров (павильон 2), аналитика (день/месяц, по сотрудникам), управление аккаунтами, печать документов.
